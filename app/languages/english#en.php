...
return [
    ...
    'global.plan_settings.documents_model.gpt_4_1106_preview' => 'Best AI model',
    'global.plan_settings.documents_model.gpt_4' => 'Best AI model',
    'global.plan_settings.documents_model.gpt_3.5_turbo_1106' => 'Incredible AI model',
    ...
    'global.plan_settings.images_api.stablediffusion' => 'StableDiffusion API',
    ...
    'index.menu' => 'Home',
    'index.title' => 'Ultimate AI Assistant',
    'index.header' => 'Enhance Your Content with <span class="text-gradient-primary" style="--gradient-one: var(--gray); --gradient-two: var(--blue);">Ultimate</span> AI Assistant',
    'index.meta_description' => '',
    'index.meta_keywords' => '',
    'index.subheader' => 'Enhance Your Workflow and Save Time with AI-Driven Content Creation! Bring Your Innovations to the Forefront with Our Premium AI Technology!',
    'index.register' => 'Sign up for free',

    'index.feature.one' => '40+ AI types',
    'index.feature.two' => 'No credit card needed',
    ...
    'index.images' => '<span class=\'text-primary-400\'>Images</span> generated by our users with AI.',
    'index.images_subheader' => 'Here\'s our latest generated images.',

    'index.widgets.one.header' => 'Choose a tool',
    'index.widgets.one.subheader' => 'Discover the Ideal Tool to Enhance Your Content Creation Journey!',
    'index.widgets.two.header' => 'Generate AI Content',
    'index.widgets.two.subheader' => '	Produce Fast and Easily with Our Robust AI Platform.',
    'index.widgets.three.header' => 'Check & polish',
    'index.widgets.three.subheader' => 'Utilize AI to Generate Top-Quality Content with Ease.',

    'index.pricing.header' => '10x your productivity',
    'index.pricing.subheader' => 'Let AI handle the task. Select the right plan for your requirements.',

    'index.chats' => 'Engage with our AI without hesitation.',
    'index.chats.subheader' => 'Feel free to express yourself when conversing with AI',
    'index.chats.messages.one' => 'Hello, could you explain how machine learning improves medical diagnostics?',
    'index.chats.messages.two' => 'Machine learning algorithms sift through extensive medical data, pinpointing patterns and predicting diseases with exceptional precision. By drawing insights from historical cases, these systems support physicians in making well-informed diagnoses, facilitating early detection and tailored treatment plans that enhance overall healthcare results.',
    'index.chats.messages.three' => 'In what ways does machine learning enhance personalized healthcare via virtual assistants?',
    'index.chats.messages.four' => 'Integrated into virtual assistants, machine learning algorithms analyze personal health data and user interactions to provide customized healthcare advice and support. Utilizing natural language processing (NLP), these assistants engage users in meaningful conversations, offering tailored insights, medication reminders, and lifestyle recommendations, thereby helping individuals manage their health more effectively.',
    ...
    'index.testimonials.one.text' => 'As a social media influencer, time is of the essence. This AI platform has revolutionized my workflow, allowing me to produce top-quality content quickly. It\'s an invaluable tool in my collection. ',
    'index.testimonials.one.name' => 'Olivia',
    'index.testimonials.one.attribute' => 'Social Media Influencer',
    'index.testimonials.two.text' => 'I\'ve used many content creation tools, but none match this AI platform. Its user-friendly interface and sophisticated algorithms make creating engaging content effortless. My followers have definitely noticed the improvement!',
    'index.testimonials.two.name' => 'Archie',
    'index.testimonials.two.attribute' => 'Content Creator',
    'index.testimonials.three.text' => 'As a content creator, continuous innovation is key. This AI platform not only simplifies my content creation process but also inspires new ideas with its smart suggestions. It\'s like having a tireless brainstorming partner.',
    'index.testimonials.three.name' => 'Alexander',
    'index.testimonials.three.attribute' => 'Content Creator',

    'index.faq.header' => '%1$sSolutions%2$s to your frequently asked %1$squestions%2$s',
    'index.faq.one.question' => 'Is DigitalStrategists beginner-friendly?',
    'index.faq.one.answer' => 'Absolutely, DigitalStrategists is created to be user-friendly, accommodating users of all expertise levels.',
    'index.faq.two.question' => 'What sets DigitalStrategists apart in the competitive content creation tools market?',
    'index.faq.two.answer' => 'DigitalStrategists stands out due to its dedication to innovation and user satisfaction, offering tailored features and an exceptional user experience.',
    'index.faq.three.question' => 'Can DigitalStrategists assist content creators in overcoming creative blocks and generating new ideas?',
    'index.faq.three.answer' => 'Absolutely! DigitalStrategists\'s AI-driven brainstorming feature offers creators personalized prompts and suggestions to spark creativity and overcome writer\'s block. By leveraging a vast database of data and trends, DigitalStrategists ensures that creators always have fresh and relevant content ideas at their fingertips.',
    'index.faq.four.question' => 'In what ways has DigitalStrategists enhanced the productivity and success of content creators?',
    'index.faq.four.answer' => 'DigitalStrategists has significantly boosted the productivity and success of content creators globally. By streamlining workflows, automating repetitive tasks, and providing valuable insights into audience preferences, DigitalStrategists helps creators produce higher-quality content more efficiently, leading to increased engagement and growth.',

    'index.cta.header' => 'Are you ready to unlock your creative potential?',
    'index.cta.subheader' => 'Log in now to access unlimited potential with our advanced AI generative tools. Let\'s innovate together!',
    ...
    'documents.create' => 'Start with Free Trail',
    ...
    'chat_create.name_x' => 'My AI Chat #%s',
